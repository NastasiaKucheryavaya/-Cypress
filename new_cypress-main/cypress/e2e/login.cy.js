...
afterEach('Конец теста', function () {
 ...
 it('Неверный логин и верный пароль', function () {
        cy.get(main_page.email).type('kucher@.ru'); //Ввели неверный логин
        cy.get(main_page.password).type(data.password); //Ввели верный пароль
 ...
 it('Проверка восстановления пароля', function () {
        ...
        cy.get(recovery_page.email).type('german@dolnikov.ru'); //Ввел верную почту для восстановления 
 ...
 it('Проверка на приведение к строчным буквам в тексте', function () {
        cy.get(main_page.email).type('GerMan@Dolnikov.ru'); //Ввели верный логин заглавными буквами
        cy.get(main_page.password).type(data.password); //Ввели верный пароль
        cy.get(main_page.login_button).click(); //Нажал войти
